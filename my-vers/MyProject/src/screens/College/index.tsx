...
import { CardCollege } from "../../components/CardCollege";
...
export default function Home() {
  ...
  function handleTaskAdd(text: string) {
    ...
    if (tasks.some((task: TaskProps) => task.title === text && task.tag==="Faculdade")) {
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        data={tasks.filter((task)=>task.tag==="Faculdade")}
